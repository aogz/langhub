...
export const translations = {
  en: {
    ...
    highlightText: 'Highlight any text to translate it and save words',
    clickParagraph: 'Or click on a paragraph to send it here for questions',
  ...
  nl: {
    ...
    highlightText: 'Markeer tekst om deze te vertalen en woorden op te slaan',
    clickParagraph: 'Of klik op een alinea om deze hier te verzenden voor vragen',
  ...
  es: {
    ...
    highlightText: 'Resalta cualquier texto para traducirlo y guardar palabras',
    clickParagraph: 'O haz clic en un párrafo para enviarlo aquí para hacer preguntas',
  ...
  fr: {
    ...
    highlightText: 'Surlignez du texte pour le traduire et enregistrer des mots',
    clickParagraph: 'Ou cliquez sur un paragraphe pour l\'envoyer ici pour des questions',
  ...
  de: {
    ...
    highlightText: 'Markieren Sie Text, um ihn zu übersetzen und Wörter zu speichern',
    clickParagraph: 'Oder klicken Sie auf einen Absatz, um ihn hier für Fragen zu senden',
  ...
  pt: {
    ...
    highlightText: 'Destaque o texto para traduzi-lo e salvar palavras',
    clickParagraph: 'Ou clique em um parágrafo para enviá-lo aqui para perguntas',
